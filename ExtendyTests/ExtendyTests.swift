...
final class ExtendyTests: XCTestCase {
	...
	func testTriadFormat() {
		...
		let result1 = string1.ext.applyFormat(.sum())
		XCTAssertEqual(result1, "1 234,00")

		let result2 = string2.ext.applyFormat(.sum())
		XCTAssertEqual(result2, "1 234,00")

		let result3 = string3.ext.applyFormat(.sum())
		XCTAssertEqual(result3, "1 234,56")

		let result4 = string4.ext.applyFormat(.sum())
		XCTAssertEqual(result4, "1 234,56")

		let result5 = string5.ext.applyFormat(.sum())
		XCTAssertEqual(result5, "0,01")

		let result6 = string6.ext.applyFormat(.sum())
		XCTAssertEqual(result6, "0,01")

		let result7 = string7.ext.applyFormat(.sum())
		XCTAssertEqual(result7, "0,00")

		let result8 = string8.ext.applyFormat(.sum())
		XCTAssertEqual(result8, "0,00")

		let result9 = string9.ext.applyFormat(.sum())
		XCTAssertEqual(result9, "0,00")

		let result10 = string10.ext.applyFormat(.sum())
		XCTAssertEqual(result10, "1 234,55")

		let result11 = string9.ext.applyFormat(.sum(minFractionDigits: 0, maxFractionDigits: 2))
		XCTAssertEqual(result11, "0")

		let result12 = string11.ext.applyFormat(.sum(minFractionDigits: 0, maxFractionDigits: 2))
	...
	func testCardFormat() {
		...
		let result1 = string1.ext.applyFormat(.creditCard)
		XCTAssertEqual(result1, "1234 5678 9012 3456")
	}
	...
	func testIbanFormat() {
		...
		let result1 = string1.ext.applyFormat(.iban)
	...
	func testCustomFormat() {
		...
		let result1 = string1.ext.applyFormat(.custom(formatter: numberFormatter))
		XCTAssertEqual(result1, "1234")

		let result2 = string2.ext.applyFormat(.custom(formatter: numberFormatter))
		XCTAssertEqual(result2, "1234")

		let result3 = string3.ext.applyFormat(.custom(formatter: numberFormatter))
		XCTAssertEqual(result3, "1234")

		let result4 = string4.ext.applyFormat(.custom(formatter: numberFormatter))
		XCTAssertEqual(result4, "1234")

		let result5 = string5.ext.applyFormat(.custom(formatter: numberFormatter))
		XCTAssertEqual(result5, "0")

		let result6 = string6.ext.applyFormat(.custom(formatter: numberFormatter))
		XCTAssertEqual(result6, "0")

		let result7 = string7.ext.applyFormat(.custom(formatter: numberFormatter))
		XCTAssertEqual(result7, "0")

		let result8 = string8.ext.applyFormat(.custom(formatter: numberFormatter))
		XCTAssertEqual(result8, "0")

		let result9 = string9.ext.applyFormat(.custom(formatter: numberFormatter))
	...
	func testClean() {
		...
		let result1 = string1.ext.clean(minFractionDigits: 0)
		XCTAssertEqual(result1, "1234")

		let result2 = string2.ext.clean(minFractionDigits: 0)
		XCTAssertEqual(result2, "1234")

		let result3 = string3.ext.clean()
		XCTAssertEqual(result3, "1234.56")

		let result4 = string4.ext.clean()
		XCTAssertEqual(result4, "1234.56")

		let result5 = string5.ext.clean()
		XCTAssertEqual(result5, "0.01")

		let result6 = string6.ext.clean()
		XCTAssertEqual(result6, "0.01")

		let result7 = string7.ext.clean()
		XCTAssertEqual(result7, "0.00")

		let result8 = string8.ext.clean()
		XCTAssertEqual(result8, "0.00")

		let result9 = string9.ext.clean()
		XCTAssertEqual(result9, "0.00")

		let result10 = string10.ext.clean(minFractionDigits: 0, maxFractionDigits: 4, groupingSeparator: ".", decimalSeparator: "_")
	...
	func testConvertDates() {
		...
		let result1 = dateTime1.ext.convertDate(from: "yyyy-MM-dd HH:mm", to: "h:mm")
		XCTAssertEqual(result1, "1:33")

		let result2 = dateTime2.ext.convertDate(from: "yyyy-MM-dd HH:mm", to: "HH:mm")
		XCTAssertEqual(result2, "13:33")

		let result3 = dateTime3.ext.convertDate(from: "yyyy-MM-dd", to: "LLL yyyy", locale: Locale(identifier: "ru_BY"))
		XCTAssertEqual(result3, "май 2020")

		XCTAssertNil(dateTime1.ext.convertDate(from: "yyyy-MM-dd", to: "HH:mm"))
	}
